...
<div id="secondary" class="widget-area four columns">
    ...
    <div id="search-2" class="widget widget_search">
        <form role="search" action="<?php echo esc_url(home_url('/')); ?>" method="get">
            <div>
                ...
                <input type="text" value="Find what you want..." onfocus="if ($(this).val() === 'Find what you want...') $(this).val('');" onblur="if ($(this).val() === '') $(this).val('Find what you want...');" name="s" id="s" />
...
<!--                <!--                <iframe src="http://player.vimeo.com/video/47828920?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=0" width="205" height="150"></iframe>-->-->
<!--                <iframe width="560" height="315" src="//www.youtube.com/embed/CQ81MQ86kM0?list=PLABDD2A2BC70EE0EA" frameborder="0" allowfullscreen></iframe>-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
    <!-- END OF VIDEO WIDGET -->
