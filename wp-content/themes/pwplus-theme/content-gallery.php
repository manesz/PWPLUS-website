...
if (!class_exists('ImageGallery')) {
    include_once("lib/class/ClassImageGallery.php");
}
$classImageGallery = new ImageGallery($wpdb);
$listImageGallery = $classImageGallery->getList();
    ...
    <div class="container container-border"  style='border-top: 1px solid #ededed;'>
        <div class="pageTitle sixteen columns"  style='margin-top: 0px;'>
            ...
            <div class="entry-breadcrumb no-flicker seven columns" style="  border: none; color: #444444; font-size: 18px">
                <p style="float: right;">You are here: <a href="<?php bloginfo('siteurl'); ?>">PWPlus.co.th</a> »  <?php the_title();?></p>
            </div>
...
<ul class="proj_list">
<?php foreach ($listImageGallery as $key => $value):?>
<!-- <?php echo $key + 1; ?>RST ELEMENT -->
<li style="margin-bottom: 20px;" data-id="id-<?php echo $key + 1; ?>" class="branding  view slides_item one-third column">
    <div class="post-thumb post-thumb-s2" >
        <ul class="ch-grid">
            <li class="nc3">
                <div class="ch-item">
                    <a style="position: relative; float: left; width: 100%; height: 100%; overflow:hidden;" href="<?php echo @$value->link; ?>">
                        <img class="img_thumb" alt="" src="<?php echo @$value->image_path; ?>" style="position:relative; height:100%; width: 100%;" />
                    </a>
                    <a class="flex_this_thumb" href="<?php echo @$value->image_path; ?>"><?php echo @$value->title; ?></a>
        ...
        <div class="no-flicker" style="position: relative; background: #EEE; padding-bottom: 15px; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">
            <div style="height: 50px;">
                <div style="padding-left: 15px; padding-top: 6px; border-top: solid 4px #DDD; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" class="p_title no-flicker">
                    <a style="-webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" href="<?php echo @$value->link; ?>"><?php echo @$value->title; ?></a>
                </div>
