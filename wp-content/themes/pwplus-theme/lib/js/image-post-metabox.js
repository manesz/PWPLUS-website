...
function getimgListUI(imgurl) {
    return '<li><input type="hidden" value="' + imgurl + '"   name="imgurl[]" /><a href="#" class="imagebig">' +
        '<img src="' + imgurl + '" width="200" onerror="defaultImage(this);"/></a>' +
        '<a href="#" class="delimgsrc"><i class="icon-cancel-2"></i></a></li>';
}
