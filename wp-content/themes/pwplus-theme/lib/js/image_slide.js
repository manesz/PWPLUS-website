        ...
        success: function (data) {
            if (data.data) {
                ...
                $.each(data.data, function (index, value) {
                    mytxt += listMenuSlide(value.image_path, value.id, value.title);
                });
...
function listMenuSlide(img, id, title) {
        ...
        if (confirm('ต้องการลบรูปนี้หรือไม่')) {
            $.ajax({
                ...
                data: {
                    post_page: post_page,
                    ran: Math.random(),
                    typePost: 'del', slideid: $(this).attr('rel'),
                    callback: 'jsonCallback'
                },
                success: function (data) {
                    if (data.data == 'success') {
...
function getJsonEdit() {
    ...
    $.ajax({
        ...
        data: {
            ...
            typePost: 'edit',
            slideid: $('div#formupdate input#slideid').val(),
            callback: 'jsonCallback'
        },
        success: function (data) {
            if (data.data == 'success') {
