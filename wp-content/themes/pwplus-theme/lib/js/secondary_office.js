...
$(document).ready(function () {
    ...
    getEventTabClick();
    $("#secondary_office-map").submit(function(){
        $.post("", $(this).serialize(),
            function (result) {
                scrollToID("#tabsholder");
...
/* SecondaryOffice Map */
function getEventSecondaryOfficeMap() {
    addFormtabEvent();
...
function getFormLoTab() {
    var formtxt = '<div class="tb-insert">' +
        '<div class="handle-head-tb"><a href="#" class="close-tb"><i class="icon-cancel"></i></a>' +
        '</div>' +
        '<table class="wp-list-table widefat" cellspacing="0" width="100%">' +
        '<tr class="alternate">' +
        '<td><label for="titlelo">Title :</label></td>' +
        '<td><input name="titlelo[]" type="text" placeholder="Title"  title="Title" value="" size="30" maxlength="255" /></td>' +
        '</tr><tbody id="the-list-edit"><tr class="alternate"><td><label for="desclo">Description :</label></td>' +
        '<td><textarea name="desclo[]" cols="70" rows="5" placeholder="Description" title="Description"></textarea></td>' +
        '</tr><tr class="alternate"><td><label for="addesslo">Addess :</label></td>' +
        '<td><textarea name="addesslo[]" cols="70" rows="5" placeholder="Addess" title="Addess"></textarea></td>' +
        '</tr><tr class="alternate"><td><label for="phonelo">Phone :</label></td>' +
        '<td><input name="phonelo[]" type="text" placeholder="Phone"  title="Phone" value="" size="30" maxlength="255" /></td>' +
        '</tr><tr class="alternate"><td><label for="faxlo">Fax :</label></td>' +
        '<td><input name="faxlo[]" type="text" placeholder="Fax"  title="Fax" value="" size="30" maxlength="255" /></td></tr>' +
        '<tr class="alternate">' +
        '<td><label for="emaillo">Email :</label></td>' +
        '<td><input name="emaillo[]" type="text" placeholder="Email"  title="Email" value="" size="30" maxlength="255" /></td>' +
        '</tr><tr class="alternate">' +
        '<td><label for="latlong">Latitude, Longitude :</label></td>' +
        '<td><input name="latlong[]" type="text" placeholder="Latitude, Longitude"  title="Latitude, Longitude" value="" size="30" maxlength="255" /></td>' +
        '</tr><tr class="alternate"><td><label for="imagelo">Image :</label></td><td><input name="imagelo[]" type="text" placeholder="Image"  title="Image" value="" size="30" maxlength="255" /><input type="button" class="button uploadimgpath" value="Upload Image"/></td></tr></tbody></table></div>';
    return formtxt;
}
