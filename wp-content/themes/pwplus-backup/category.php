...
<div class="fullwidth-container" style="position: relative;float: left; height: 110px; width: 100%;height: 110px;background: white;">
    <div class="container container-border"  style='border-top: 1px solid #ededed;'>
        <div class="pageTitle sixteen columns"  style='margin-top: 0px;'>
            <h3 class="page_title nine columns" style="color: #444444; font-size: 18px"><?php the_category();?></h3>
                    ...
                    <li style="margin-bottom: 20px;" data-id="id-1" class="branding  view slides_item one-third column">
                        <div class="post-thumb post-thumb-s2" >
                            <ul class="ch-grid">
                                <li class="nc3">
                                    <div class="ch-item">
                                        <a style="position: relative; float: left; width: 100%; height: 100%; overflow:hidden; text-align: center;" href="<?php echo the_permalink();?>">
...
//                                                echo the_post_thumbnail( $postID, $size, $attr );
                                                if(!empty($url)){
                                            ?>
                                                <img class="img_thumb" alt="" src="<?php echo $url;?>" style="position:relative; height: auto%; width: 100%; padding-left: -20%;" />
                                            <?php
                                                } else {
                                            ?>
                                                    <img class="img_thumb" alt="" src="<?php echo get_template_directory_uri();?>/assets/img/thumb.png" style="position:relative; height:100%; width: auto; padding-left: -20%;" />
                                            <?php
                                                }
                                            ?>
                                        </a>
                                        <?php if(!empty($url)){ ?>
                                        <a class="flex_this_thumb" href="<?php echo $url;?>"><?php echo the_title();?></a>
                                        <? }?>
                                        <div class="hover_the_thumbs" style="position: absolute; float: left; width: 100%; height: 100%;">
                                            <div class="magnify_this_thumb" style="position: absolute; width: 30px; height: 30px; top: 43%; float: left; left: -15%; color: black; background: white;"  >
                                                <img src="<?php echo get_template_directory_uri();?>/assets/img/magnifying_glass_16x16.png" style="margin-top: 7px; opacity: .8 !important;" alt=""/>
                                            </div>
                                            <div class="hyperlink_this_thumb"  style="position: absolute; width: 30px; height: 30px; top: 43%; float: left; left: 105%; color: black; background: white;">
                                                <img src="<?php echo get_template_directory_uri();?>/assets/img/link_16x16.png" style="margin-top: 7px; opacity: .8 !important;" alt=""/>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <div class="no-flicker" style="position: relative; background: #EEE; padding-bottom: 15px; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">
                                <div style="height: 50px;">
                                    <div style="padding-left: 15px; padding-top: 6px; border-top: solid 4px #DDD; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" class="p_title no-flicker">
                                        <a style="-webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" href="<?php echo the_permalink();?>"><?php the_title();?></a>
                                    </div>
