...
<!-- START: PAGE TITLE -->
<div class="fullwidth-container" style="position: relative;float: left; height: 110px; width: 100%;height: 110px;background: white;">
    <div class="container container-border"  style='border-top: 1px solid #ededed;'>
        <div class="pageTitle sixteen columns"  style='margin-top: 0px;'>
            <h3 class="page_title nine columns" style="color: #444444; font-size: 18px">Portfolio 3 Columns - Quicksand Effect</h3>
            <div class="entry-breadcrumb no-flicker seven columns" style="  border: none; color: #444444; font-size: 18px">
...
<!-- 1RST ELEMENT -->
<li style="margin-bottom: 20px;" data-id="id-1" class="branding  view slides_item one-third column">
    <div class="post-thumb post-thumb-s2" >
        <ul class="ch-grid">
            <li class="nc3">
                <div class="ch-item">
                    <a style="position: relative; float: left; width: 100%; height: 100%; overflow:hidden;" href="single.php">
                        <img class="img_thumb" alt="" src="assets/img/pattern5.jpg" style="position:relative; height:100%; width: 100%;" />
                    </a>
                    <a class="flex_this_thumb" href="http://designarethemes.com/themes/freshlookwp/wp-content/uploads/2012/11/thumb_1.jpg">prettyphoto</a>
                    <div class="hover_the_thumbs" style="position: absolute; float: left; width: 100%; height: 100%;">
                        <div class="magnify_this_thumb" style="position: absolute; width: 30px; height: 30px; top: 43%; float: left; left: -15%; color: black; background: white;"  >
                            <img src="http://designarethemes.com/themes/freshlookwp/wp-content/themes/freshlook/img/magnifying_glass_16x16.png" style="margin-top: 7px; opacity: .8 !important;" alt=""/>
                        </div>
                        <div class="hyperlink_this_thumb"  style="position: absolute; width: 30px; height: 30px; top: 43%; float: left; left: 105%; color: black; background: white;">
                            <img src="http://designarethemes.com/themes/freshlookwp/wp-content/themes/freshlook/img/link_16x16.png" style="margin-top: 7px; opacity: .8 !important;" alt=""/>
                        </div>
                    </div>
                </div>
            </li>
        ...
        <div class="no-flicker" style="position: relative; background: #EEE; padding-bottom: 15px; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">
            <div style="height: 50px;">
                <div style="padding-left: 15px; padding-top: 6px; border-top: solid 4px #DDD; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" class="p_title no-flicker">
                    <a style="-webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" href="single-project.html">Winged Angel</a>
                </div>
                <div style="padding-left: 15px;" class="p_exerpt no-flicker">
                    <p style="height: 18px; overflow-y: hidden; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">Branding</p>
                    <div style="width: 0; height: 0; border-bottom: 15px solid white; border-left: 15px solid transparent; position: absolute; right: 0px;"></div>
                </div>
            </div>
        </div>
    </div>
...
<!-- 2ND ELEMENT -->
<li style="margin-bottom: 20px;" data-id="id-2" class="illustration  view slides_item one-third column">								 						<div class="post-thumb post-thumb-s2"  >
    <ul class="ch-grid">
        <li class="nc3">
            <div class="ch-item">
                <a style="position: relative; float: left; width: 100%; height: 100%; overflow:hidden;" href="single.php">
                ...
                <a class="flex_this_thumb" href="http://designarethemes.com/themes/freshlookwp/wp-content/uploads/2012/11/thumb_2.jpg">prettyphoto</a>
                <div class="hover_the_thumbs" style="position: absolute; float: left; width: 100%; height: 100%;">
                    <div class="magnify_this_thumb" style="position: absolute; width: 30px; height: 30px; top: 43%; float: left; left: -15%; color: black; background: white;"  >
                        <img src="http://designarethemes.com/themes/freshlookwp/wp-content/themes/freshlook/img/magnifying_glass_16x16.png" style="margin-top: 7px; opacity: .8 !important;" alt=""/>
                    </div>
    ...
    <div class="no-flicker" style="position: relative; background: #EEE; padding-bottom: 15px; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">
        <div style="height: 50px;">
            <div style="padding-left: 15px; padding-top: 6px; border-top: solid 4px #DDD; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" class="p_title no-flicker">
                <a style="-webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" href="single-project.html">Not the end</a>
            </div>
            <div style="padding-left: 15px;" class="p_exerpt no-flicker">
                <p style="height: 18px; overflow-y: hidden; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">Illustration</p>
                <div style="width: 0; height: 0; border-bottom: 15px solid white; border-left: 15px solid transparent; position: absolute; right: 0px;"></div>
            </div>
        </div>
    </div>
...
<!-- 3RD ELEMENT -->
<li style="margin-bottom: 20px;" data-id="id-3" class="branding illustration  view slides_item one-third column">								 				<div class="post-thumb post-thumb-s2">
    <ul class="ch-grid">
        <li class="nc3">
            <div class="ch-item">
                <a style="position: relative; float: left; width: 100%; height: 100%; overflow:hidden;" href="single.php">
                ...
                <a class="flex_this_thumb" href="http://designarethemes.com/themes/freshlookwp/wp-content/uploads/2012/11/thumb_555.png">prettyphoto</a>
                <div class="hover_the_thumbs" style="position: absolute; float: left; width: 100%; height: 100%;">
                    <div class="magnify_this_thumb" style="position: absolute; width: 30px; height: 30px; top: 43%; float: left; left: -15%; color: black; background: white;"  >
                        <img src="http://designarethemes.com/themes/freshlookwp/wp-content/themes/freshlook/img/magnifying_glass_16x16.png" style="margin-top: 7px; opacity: .8 !important;" alt=""/>
                    </div>
    ...
    <div class="no-flicker" style="position: relative; background: #EEE; padding-bottom: 15px; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">
        <div style="height: 50px;">
            <div style="padding-left: 15px; padding-top: 6px; border-top: solid 4px #DDD; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" class="p_title no-flicker">
                <a style="-webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" href="single-project.html">Tap Wall &#8211; Boxed</a>
            </div>
            <div style="padding-left: 15px;" class="p_exerpt no-flicker">
                <p style="height: 18px; overflow-y: hidden; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">Branding, Illustration</p>
                <div style="width: 0; height: 0; border-bottom: 15px solid white; border-left: 15px solid transparent; position: absolute; right: 0px;"></div>
            </div>
        </div>
    </div>
...
<!-- 4TH ELEMENT -->
<li style="margin-bottom: 20px;" data-id="id-4" class="photography  view slides_item one-third column">
    <div class="post-thumb post-thumb-s2" >
        <ul class="ch-grid">
            <li class="nc3">
                <div class="ch-item">
                    ...
                    <a class="flex_this_thumb" href="http://designarethemes.com/themes/freshlookwp/wp-content/uploads/2012/11/thumb_33.png">prettyphoto</a>
                    <div class="hover_the_thumbs" style="position: absolute; float: left; width: 100%; height: 100%;">
                        <div class="magnify_this_thumb" style="position: absolute; width: 30px; height: 30px; top: 43%; float: left; left: -15%; color: black; background: white;"  >
                            <img src="http://designarethemes.com/themes/freshlookwp/wp-content/themes/freshlook/img/magnifying_glass_16x16.png" style="margin-top: 7px; opacity: .8 !important;" alt=""/>
                        </div>
        ...
        <div class="no-flicker" style="position: relative; background: #EEE; padding-bottom: 15px; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">
            <div style="height: 50px;">
                <div style="padding-left: 15px; padding-top: 6px; border-top: solid 4px #DDD; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" class="p_title no-flicker">
                    <a style="-webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" href="single-project.html">Refined Boxed</a>
                </div>
                <div style="padding-left: 15px;" class="p_exerpt no-flicker">
                    <p style="height: 18px; overflow-y: hidden; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">Photography</p>
                    <div style="width: 0; height: 0; border-bottom: 15px solid white; border-left: 15px solid transparent; position: absolute; right: 0px;"></div>
                </div>
            </div>
        </div>
...
<!-- 5TH ELEMENT -->
<li style="margin-bottom: 20px;" data-id="id-5" class="branding illustration  view slides_item one-third column">
    <div class="post-thumb post-thumb-s2" >
        <ul class="ch-grid">
            <li class="nc3">
                <div class="ch-item">
                    ...
                    <a class="flex_this_thumb" href="http://designarethemes.com/themes/freshlookwp/wp-content/uploads/2012/11/thumb_3.jpg">prettyphoto</a>
                    <div class="hover_the_thumbs" style="position: absolute; float: left; width: 100%; height: 100%;">
                        <div class="magnify_this_thumb" style="position: absolute; width: 30px; height: 30px; top: 43%; float: left; left: -15%; color: black; background: white;"  >
                            <img src="http://designarethemes.com/themes/freshlookwp/wp-content/themes/freshlook/img/magnifying_glass_16x16.png" style="margin-top: 7px; opacity: .8 !important;" alt=""/>
                        </div>
        ...
        <div class="no-flicker" style="position: relative; background: #EEE; padding-bottom: 15px; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">
            <div style="height: 50px;">
                <div style="padding-left: 15px; padding-top: 6px; border-top: solid 4px #DDD; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" class="p_title no-flicker">
                    <a style="-webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" href="single-project.html">TapWall</a>
                </div>
                <div style="padding-left: 15px;" class="p_exerpt no-flicker">
                    <p style="height: 18px; overflow-y: hidden; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">Branding, Illustration</p>
                    <div style="width: 0; height: 0; border-bottom: 15px solid white; border-left: 15px solid transparent; position: absolute; right: 0px;"></div>
...
<!-- 6TH ELEMENT -->
<li style="margin-bottom: 20px;" data-id="id-6" class="photography web-design  view slides_item one-third column">								 				<div class="post-thumb post-thumb-s2" >
    <ul class="ch-grid">
        <li class="nc3">
            <div class="ch-item">
                <a style="position: relative; float: left; width: 100%; height: 100%; overflow:hidden;" href="single.php">
                ...
                <a class="flex_this_thumb" href="http://designarethemes.com/themes/freshlookwp/wp-content/uploads/2012/11/thumb_4.jpg">prettyphoto</a>
                <div class="hover_the_thumbs" style="position: absolute; float: left; width: 100%; height: 100%;">
                    <div class="magnify_this_thumb" style="position: absolute; width: 30px; height: 30px; top: 43%; float: left; left: -15%; color: black; background: white;"  >
                        <img src="http://designarethemes.com/themes/freshlookwp/wp-content/themes/freshlook/img/magnifying_glass_16x16.png" style="margin-top: 7px; opacity: .8 !important;" alt=""/>
                    </div>
    ...
    <div class="no-flicker" style="position: relative; background: #EEE; padding-bottom: 15px; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">
        <div style="height: 50px;">
            <div style="padding-left: 15px; padding-top: 6px; border-top: solid 4px #DDD; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" class="p_title no-flicker">
                <a style="-webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" href="single-project.html">Refined</a>
            </div>
            <div style="padding-left: 15px;" class="p_exerpt no-flicker">
                <p style="height: 18px; overflow-y: hidden; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">Photography, Web Design</p>
                <div style="width: 0; height: 0; border-bottom: 15px solid white; border-left: 15px solid transparent; position: absolute; right: 0px;"></div>
            </div>
        </div>
    </div>
...
<!-- 7TH ELEMENT -->
<li style="margin-bottom: 20px;" data-id="id-7" class="illustration photography  view slides_item one-third column">								 			<div class="post-thumb post-thumb-s2" >
    <ul class="ch-grid">
        <li class="nc3">
            <div class="ch-item">
                <a style="position: relative; float: left; width: 100%; height: 100%; overflow:hidden;" href="single.php">
                ...
                <a class="flex_this_thumb" href="http://designarethemes.com/themes/freshlookwp/wp-content/uploads/2012/11/thumb_5.jpg">prettyphoto</a>
                <div class="hover_the_thumbs" style="position: absolute; float: left; width: 100%; height: 100%;">
                    <div class="magnify_this_thumb" style="position: absolute; width: 30px; height: 30px; top: 43%; float: left; left: -15%; color: black; background: white;"  >
                        <img src="http://designarethemes.com/themes/freshlookwp/wp-content/themes/freshlook/img/magnifying_glass_16x16.png" style="margin-top: 7px; opacity: .8 !important;" alt=""/>
                    </div>
    ...
    <div class="no-flicker" style="position: relative; background: #EEE; padding-bottom: 15px; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">
        <div style="height: 50px;">
            <div style="padding-left: 15px; padding-top: 6px; border-top: solid 4px #DDD; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" class="p_title no-flicker">
                <a style="-webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" href="single-project.html">AlteredPart02</a>
            </div>
            <div style="padding-left: 15px;" class="p_exerpt no-flicker">
                <p style="height: 18px; overflow-y: hidden; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">Illustration, Photography</p>
                <div style="width: 0; height: 0; border-bottom: 15px solid white; border-left: 15px solid transparent; position: absolute; right: 0px;"></div>
            </div>
        </div>
    </div>
...
<!-- 8TH ELEMENT -->
<li style="margin-bottom: 20px;" data-id="id-8" class="illustration  view slides_item one-third column">								 						<div class="post-thumb post-thumb-s2" >
    <ul class="ch-grid">
        <li class="nc3">
            <div class="ch-item">
                <a style="position: relative; float: left; width: 100%; height: 100%; overflow:hidden;" href="single.php">
                ...
                <a class="flex_this_thumb" href="http://designarethemes.com/themes/freshlookwp/wp-content/uploads/2012/11/thumb_6.jpg">prettyphoto</a>
                <div class="hover_the_thumbs" style="position: absolute; float: left; width: 100%; height: 100%;">
                    <div class="magnify_this_thumb" style="position: absolute; width: 30px; height: 30px; top: 43%; float: left; left: -15%; color: black; background: white;"  >
                        <img src="http://designarethemes.com/themes/freshlookwp/wp-content/themes/freshlook/img/magnifying_glass_16x16.png" style="margin-top: 7px; opacity: .8 !important;" alt=""/>
                    </div>
    ...
    <div class="no-flicker" style="position: relative; background: #EEE; padding-bottom: 15px; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">
        <div style="height: 50px;">
            <div style="padding-left: 15px; padding-top: 6px; border-top: solid 4px #DDD; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" class="p_title no-flicker">
                <a style="-webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" href="single-project.html">Absolut</a>
            </div>
            <div style="padding-left: 15px;" class="p_exerpt no-flicker">
                <p style="height: 18px; overflow-y: hidden; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">Illustration</p>
                <div style="width: 0; height: 0; border-bottom: 15px solid white; border-left: 15px solid transparent; position: absolute; right: 0px;"></div>
...
<!-- 9TH ELEMENT -->
<li style="margin-bottom: 20px;" data-id="id-9" class="video  view slides_item one-third column">
    <div class="post-thumb post-thumb-s2" >
        <ul class="ch-grid">
            <li class="nc3">
                <div class="ch-item">
                    ...
                    <a class="flex_this_thumb" href="http://designarethemes.com/themes/freshlookwp/wp-content/uploads/2012/12/thumb_7.jpg">prettyphoto</a>
                    <div class="hover_the_thumbs" style="position: absolute; float: left; width: 100%; height: 100%;">
                        <div class="magnify_this_thumb" style="position: absolute; width: 30px; height: 30px; top: 43%; float: left; left: -15%; color: black; background: white;"  >
                            <img src="http://designarethemes.com/themes/freshlookwp/wp-content/themes/freshlook/img/magnifying_glass_16x16.png" style="margin-top: 7px; opacity: .8 !important;" alt=""/>
                        </div>
        ...
        <div class="no-flicker" style="position: relative; background: #EEE; padding-bottom: 15px; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">
            <div style="height: 50px;">
                <div style="padding-left: 15px; padding-top: 6px; border-top: solid 4px #DDD; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" class="p_title no-flicker">
                    <a style="-webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;" href="single-project.html">Video Project</a>
                </div>
                <div style="padding-left: 15px;" class="p_exerpt no-flicker">
                    <p style="height: 18px; overflow-y: hidden; -webkit-transition: all 0.4s ease-in-out; -moz-transition: all 0.4s ease-in-out; -o-transition: all 0.4s ease-in-out; -ms-transition: all 0.4s ease-in-out; transition: all 0.4s ease-in-out;">Video</p>
                    <div style="width: 0; height: 0; border-bottom: 15px solid white; border-left: 15px solid transparent; position: absolute; right: 0px;"></div>
                </div>
            </div>
        </div>
