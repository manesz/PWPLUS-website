    ...
    <div class="container container-border"  style='border-top: 1px solid #ededed;'>
        <div class="pageTitle sixteen columns"  style='margin-top: 0px;'>
            ...
            <div class="entry-breadcrumb no-flicker seven columns" style="  border: none; color: #444444; font-size: 18px">
                <p style="float: right;">You are here: <a href="<?php bloginfo('siteurl'); ?>">PWPlus.co.th</a> »  <a href="#">Category</a> »  <?php the_title();?></p>
            </div>
...
<!--                            <ul class="slides">-->
<!--                                <li>-->
<!--                                    <a href='javascript:;'><img src='--><?php //echo get_template_directory_uri();?><!--/assets/img/products/img-slide.jpg' alt='' ></a>-->
<!---->
<!--                                    <p class='flex-caption'><span class='caption-title'>Unlimited Colors & Sidebars</span></p>-->
<!--                                </li>-->
<!--                            </ul>-->
<!--                        </div>-->
<!--                        <p class="des-sc-dots-divider"><a name="external" id="external"></a></p>-->
