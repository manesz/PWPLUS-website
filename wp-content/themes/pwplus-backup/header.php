            ...
            <div class="logo_and_menu">
                ...
                <div class="logo five columns">
                    <a href="index.html" tabindex="-1" style="text-indent: 0px;">
                        <h1 class="logo" style="width: 143px; height: 35px; top: 24px; left: 0px; background: url('<?php echo get_template_directory_uri();?>/assets/img/logo.png'); font-size: 12px;"></h1>
                    </a>

                    <div class="slogan" style="background: none; font-family: 'Georgia'; font-style: italic; font-size: 12px; color: #cccccc;">รากฟันเทียมไทย</div>
                </div>

                <?php
                    get_template_part( 'navigator' );
                ?>
