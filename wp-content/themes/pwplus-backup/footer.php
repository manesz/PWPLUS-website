...
<!--                                <div class="recentPostsSidebar slider"></div>-->
                                <?php
                                    ...
                                    if(empty($url)){
                                        $url = get_template_directory_uri().'/assets/img/thumb.png';
                                    }
                                ?>
                                <div style="width: 40px; height: 40px; overflow: hidden; background: url('<?php echo $url;?>') no-repeat center center; background-size: 80px auto; position: relative; float: left; margin-right: 5px;"></div>

                                <div class="rc-container">
                                    <a class="the_title" href="<?php echo get_permalink($recent["ID"]);?>"><?php echo $recent["post_title"];?></a><br>
                                    <span style="float:left;font-size: 11px; color: #999;font-weight: normal;" class="blog-i">Category:&nbsp;</span>
                                    <a style="font-size:11px;" class="the_author" href="#">
                                        <?php
...
<!-- IMAGE LOADER -->
<div style="display:none;" class="loadinger"><img alt="loading" src="<?php echo get_template_directory_uri();?>/assets/img/ajx_loading.gif"></div>
