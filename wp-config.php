...
define('DB_NAME', 'id3ac0rn3r_pwplus');

/** MySQL database username */
define('DB_USER', 'id3ac0rn3r_cuspp');

/** MySQL database password */
define('DB_PASSWORD', 'p@ssw0rdpwplus');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'bbmOdF?ew!Rvg4C%#;+gDgh;&$`Gr1{`G}gy:v v=-7G,?*NqjOx#8GYECH__.S?');
define('SECURE_AUTH_KEY',  'Gh}9WgMLwp`xO^_;iZ:=(J(raVlNX{-d65gJBqLLM;c|vEerszh! F19Hao<HMzq');
define('LOGGED_IN_KEY',    '!pZgTdsGBNHz<G@t@6{1Y-`@e$m~wac,[j>Wg=L&|.s/3CS#LEVF>AM}c_&kREiJ');
define('NONCE_KEY',        'qf_(Be;8WKzxj,zPVXr(qT-AWwTeQ.jP[3_b9L5u:VKKbQ3uO~jF;QRJnWHba#f[');
define('AUTH_SALT',        'y>Z=ILh5T#}7Wa]Hy}I6x[p]p*5sz0/alAC#<yVps)7i+T=b^;@evdv~YAd-8EW[');
define('SECURE_AUTH_SALT', 'Nnh(YnZF>Lr2_-1S`HREQSU+c)~Nc4o$ vV>c<vW4%q=teGGY^VHOj~ZqrsR_cCd');
define('LOGGED_IN_SALT',   'G(<./?Y4eHWG,2&`VKl#Cxl83lr73[vz>-f<oDAz$bjIJk_c?@N*1Zr*{KH.A=H*');
define('NONCE_SALT',       'iWhMNG!aWc|vn*52SpMSAJ-sBD<!%bp`i%&pj7)UhCT3~hGLq^*Vjt-f.c7V%0fU');
